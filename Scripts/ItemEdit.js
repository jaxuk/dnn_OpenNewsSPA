var dnn_OpenNewsSPA = dnn_OpenNewsSPA || {};

dnn_OpenNewsSPA.itemViewModel = function (moduleId, resx) {
    var service = {
    ...
    var loadUsers = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var result = data[i];
            var user = new dnn_OpenNewsSPA.user(result.id, result.name);
...
dnn_OpenNewsSPA.user = function (id, name) {
    this.id = id;
    this.name = name;
}